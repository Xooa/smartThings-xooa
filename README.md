...
10. Copy the **App ID** from the `Basic Information` tab on the Apps dashboard. You will need this ID later to connect the SmartApp.
...
9. Click on any device to view all the past logged events for that device.
